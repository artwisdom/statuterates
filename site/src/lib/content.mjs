...
the judgment is entered — currently 8.75%, as simple interest.`,
  ...
  "colorado-prejudgment-rate": {
    tagline: "Colorado’s prejudgment interest rate — when a court awards it.",
    q: "What is the Colorado prejudgment interest rate?",
    body: "Colorado prejudgment interest is 8% per year, compounded annually under C.R.S. 5-12-102. Prejudgment interest is NOT limited to liquidated/ascertainable sums.",
    prejudgment: true,
    kind: "fixed",
    kindLabel: "Fixed by statute",
