...
the judgment is entered — currently 8.75%, as simple interest.`,
  ...
  "kansas-judgment-rate": {
    ...
    body: "Kansas post-judgment interest is currently 8.25% — a statutory formula rate under Kan. Stat. Ann. 16-204 that resets each year. This 16-204 rate is POST-judgment. Prejudgment interest is governed separately by K.S.A. 16-201 (10% per annum when no other rate agreed). CONTRACT:…",
  },
  ...
  "nebraska-judgment-rate": {
    ...
    body: "Nebraska post-judgment interest is currently 5.723% — a statutory formula rate under Neb. Rev. Stat. § 45-103 that resets each quarter. Statutory rate does NOT apply where (1) the interest rate is specifically provided by other law, or (2) the action is founded on an oral or written…",
  },
  ...
  "kansas-prejudgment-rate": {
    ...
    body: "Kansas prejudgment interest is 10% for general/contract claims (K.S.A. 16-201), but for civil tort actions filed on or after July 1, 2023 it is the judgment rate minus 2 points — currently 6.25%. Prejudgment interest is available only on LIQUIDATED claims — where both the amount due and the date it became due are fixed and certain, or definitely ascertainable by mathematical…",
    prejudgment: true,
    kind: "fixed",
    kindLabel: "Fixed by statute",
  ...
  "nebraska-prejudgment-rate": {
    ...
    body: "Nebraska prejudgment interest is 12% for liquidated claims (§45-104), but unliquidated tort/personal-injury claims accrue the variable judgment rate — currently 5.723% — under §45-103.02(1). Prejudgment interest is NOT freely available on all claims — Nebraska splits by claim type.",
    prejudgment: true,
    kind: "fixed",
    kindLabel: "Fixed by statute",
